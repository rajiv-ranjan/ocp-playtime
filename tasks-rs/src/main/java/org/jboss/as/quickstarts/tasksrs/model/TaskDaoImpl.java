...
public class TaskDaoImpl implements TaskDao {
    ...
    @Override
    public void createTask(Users user, Task task) {
        if (!em.contains(user)) {
            user = em.merge(user);
        }
    ...
    @Override
    public List<Task> getAll(Users user) {
        TypedQuery<Task> query = querySelectAllTasksFromUser(user);
        return query.getResultList();
    }

    @Override
    public List<Task> getRange(Users user, int offset, int count) {
        TypedQuery<Task> query = querySelectAllTasksFromUser(user);
    ...
    @Override
    public List<Task> getForTitle(Users user, String title) {
    ...
    private TypedQuery<Task> querySelectAllTasksFromUser(Users user) {
